...
| tokio | 1.53.1 | MIT | One process runtime, bounded channels, async process/update I/O | Yes |
...
| reqwest | 0.13.4 | MIT OR Apache-2.0 | Explicit-update-only GitHub HTTPS metadata and streaming asset transport with Rustls, system certificates, and system proxy behavior | Update command only |
| semver | 1.0.28 | MIT OR Apache-2.0 | Strict release-tag parsing and SemVer precedence selection | Update command only |
